...
if __name__ == "__main__":
    ...
    stocks = sqlContext.sql("select split(rowkey, '_')[1] as date, code, name, price, delta_ratio, delta, start, last, height, low from hbase_stock")\
    ...
    print stocks
    print float(stocks[1])/float(stocks[1]+stocks[2]), float(stocks[2])/float(stocks[1]+stocks[2])

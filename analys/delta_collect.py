...
select_stock = "select split(rowkey, '_')[1] as date, code, name, delta_ratio from hbase_stock where split(rowkey, '_')[1] > '{0}'"
select_stock = "select split(rowkey, '_')[1] as date, code, name, delta_ratio from hbase_stock where split(rowkey, '_')[1] > '{0}' and code = '600048'"
